...
`elsif P4
    `define ROM_FILE "./../00_TESTBED/P4/rom.dat"
    `define PARAM_FILE "./../00_TESTBED/P4/param.dat"
    `define GOLDEN_FILE "./../00_TESTBED/P4/golden.dat"
`else 
    `define ROM_FILE "./../00_TESTBED/P1/rom.dat"
    `define PARAM_FILE "./../00_TESTBED/P1/param.dat"
    `define GOLDEN_FILE "./../00_TESTBED/P1/golden.dat"
...
`elsif APR
    `define SDFFILE "./interpolation_apr.sdf"
`endif
